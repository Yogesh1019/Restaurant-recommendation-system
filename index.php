...
<script src="data/all.js" id="facebook-jssdk"></script>
		...
		<div class="row" >
		    <div class="col-md-12" style="background: #000;">
			    <div class="breadcrumbs" style="text-align:right;">
				    <ul class="breadcrumb" style="background: #004F91;padding-right:20px;"> 
					<?php 
...
echo "Welcome ".$_SESSION['username'];
					...
					{
						echo '<li><a href="index.php?page=4" id="myliks">Sign In</a></li>';
						echo '<li><a href="index.php?page=5" id="myliks">Sign Up</a></li>';
					}
					?>
...
elseif($_GET["page"]==3)
{
include("RestaurantSuggestion.php");
}
elseif($_GET["page"]==4)
{
...
<div id="alertWindow1">
    <div id="abc1">You'll be redirect to google.com. Continue?</div>
    <br />
