...
$("#logresult").html(html);
						 ...
						 <form class="loginbox form-horizontal" id="regformsubmit">
				            ...
				            <div class="form-group">
					            ...
					            <div class="col-md-8">
					                <input class="form-control" type="text" name="FullNam">
					  				            ...
					  				            <div class="form-group">
					            <label class="control-label col-md-4" for="inputEmail" >User Name<span class="required">*</span></label>
					            <div class="col-md-8">
					                <input id="inputEmail" class="form-control" type="text" name="Usernm">
					            </div>
				            </div>
				            ...
				            <div class="form-group">
					            ...
					            <div class="form-group"><label class="control-label col-md-4" for="inputEmail" >Gender<span class="required">*</span></label>
					            <div class="col-md-8">
					               <table><tr><td><input type="radio" name="Gender" value="M" Checked> Male</td></tr>
									<tr><td><input type="radio" name="Gender" value="F"> Female</td></tr></table>
					            </div> </div>
